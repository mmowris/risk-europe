...
export class City {
	...
	public static init() {
		...
		Cities[15] = new City(709.0, -5157.0, UID.PORT)
		...
		// Catalonia
		Cities[86] = new City(-6910.0, -8350.0, UID.CITY)
		Cities[90] = new City(-5788.0, -7322.0, UID.CITY)
		//France
		...
		Cities[94] = new City(-4820.0, -3060.0, UID.CITY)
		...
		// Normandy
		Cities[95] = new City(-6179.0, -2850.0, UID.CITY)
		Cities[96] = new City(-6944.0, -4704.0, UID.PORT)
		//Switzerland
