...
export class Country {
	...
	public static init() {
		...
		Country.fromName.set("Spain", new Country("Spain", -8896.0, -8384.0, Cities[84], Cities[85], Cities[87], Cities[88], Cities[89]));
		Country.fromName.set("Catalonia", new Country("Catalonia", -6212.0, -8003.0, Cities[86], Cities[90]));
		...
		Country.fromName.set("France", new Country("France", -4285.0, -4816.0, Cities[91], Cities[92], Cities[93], Cities[94], Cities[97]));
		Country.fromName.set("Normandy", new Country("Normandy", -6215.0, -4016.0 , Cities[95], Cities[96]));
